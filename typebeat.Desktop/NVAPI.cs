...
namespace typebeat.Desktop
{
    ...
    {
        private const string osu_filename = "type!beat.exe";
        ...
        public const string APPLICATION_NAME = @"type!beat";
        public const string PROFILE_NAME = @"type!beat";
        ...
        private static bool setSetting(NvSettingID settingId, uint settingValue)
        {
            ...
            {
                // We don't want to interfere with the user's other settings, so let's create a separate config for type!beat
