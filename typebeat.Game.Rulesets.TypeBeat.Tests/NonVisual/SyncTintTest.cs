...
namespace typebeat.Game.Rulesets.TypeBeat.Tests.NonVisual
{
    ...
    /// is exactly 0 at and beyond the Meh-window edges while the cell still lands Correct, so an
    ...
    public class SyncTintTest
    {
        ...
        public void RealDeltasRankTheWayThePlayerWouldExpect()
        {
            ...
            var mehEdge = tint(windows.SyncQuality(windows.MehLate));
            ...
            // The Meh edge is quality 0, and everything past it stays there: this is exactly the
            // case that would have painted an untyped grey without the floor.
