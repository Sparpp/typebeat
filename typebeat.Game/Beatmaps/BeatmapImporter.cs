...
namespace typebeat.Game.Beatmaps
{
    ...
    {
        public override IEnumerable<string> HandledExtensions => new[] { ".osz", ".typb" };
        ...
        private List<BeatmapInfo> createBeatmapDifficulties(BeatmapSetInfo beatmapSet, Realm realm)
        {
            ...
            // https://github.com/peppy/osu-stable-reference/blob/67795dba3c308e7d0493b296149dcb073ca47ecb/type!beat/GameplayElements/Beatmaps/BeatmapManager.cs#L207-L208
