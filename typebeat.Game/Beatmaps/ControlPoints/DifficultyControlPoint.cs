...
namespace typebeat.Game.Beatmaps.ControlPoints
{
    /// <remarks>
    ...
    public class DifficultyControlPoint : ControlPoint, IEquatable<DifficultyControlPoint>
    {
        ...
        /// This exists for backwards compatibility with maps that abuse NaN slider velocity behavior on type!beatstable (e.g. /b/2628991).
        /// </summary>
