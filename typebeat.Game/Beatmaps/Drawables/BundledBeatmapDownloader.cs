...
namespace typebeat.Game.Beatmaps.Drawables
{
    ...
    public partial class BundledBeatmapDownloader : CompositeDrawable
    {
         ...
         *    (which is prob fine when maps are presented as user-generated content), but for a new type!beat player, it's easy to assume bundled maps are
        ...
        private static readonly string[] bundled_taiko =
        {
            ...
            "1236083 meganeko - Sirius A (type!beat edit).osz",
            ...
            "1818361 meganeko - Feral (type!beat edit).osz",
