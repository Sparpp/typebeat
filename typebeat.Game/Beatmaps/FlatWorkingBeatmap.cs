...
namespace typebeat.Game.Beatmaps
{
    ...
    /// <see cref="WorkingBeatmap.GetPlayableBeatmap(typebeat.Game.Rulesets.IRulesetInfo,System.Collections.Generic.IReadOnlyList{typebeat.Game.Rulesets.Mods.Mod})"/>.
    /// </summary>
