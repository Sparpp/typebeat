...
namespace typebeat.Game.Beatmaps.Formats
{
        ...
        where T : new()
    {
        ...
        ///
        /// type!beatstable's versions end at <see cref="LATEST_VERSION"/>.
        /// type!beat's versions starts at <see cref="LegacyBeatmapEncoder.FIRST_LAZER_VERSION"/>.
        /// </summary>
        ...
        public enum Section
        {
            ...
            /// <summary>
            /// type!beat fork extension: the lyric-line payload of the "type!beat file format".
            /// Handled by the typebeat ruleset's decoder; unknown to stock legacy decoders (ignored).
            /// </summary>
            Lyrics,
        }
