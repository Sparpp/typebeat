...
using typebeat.Game.Storyboards.Commands;
...
namespace typebeat.Game.Beatmaps.Formats
{
    public class LegacyStoryboardEncoder
    {
        ...
        {
            // https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/type!beat/GameModes/Edit/Modes/EditorModeDesign.cs#L189
            // https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/type!beat/GameplayElements/Events/EventManager.cs#L368
            writer.WriteLine(@"// Background and Video events");

            if (target == StoryboardElementSource.Beatmap)
            {
                // https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/type!beat/GameplayElements/HitObjectManager_LoadSave.cs#L1499
            ...
            // https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/type!beat/GameplayElements/HitObjectManager_LoadSave.cs#L1496
            ...
            // https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/type!beat/GameplayElements/HitObjectManager_LoadSave.cs#L1478-L1481
            ...
            foreach (var element in layer.Elements.Where(elem => elem.Source == target))
            {
                ...
                switch (element)
                {
                    case StoryboardAnimation animation:
                    {
                        ...
                        // https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/type!beat/GameplayElements/HitObjectManager_LoadSave.cs#L1505-L1507
                    ...
                    case StoryboardSprite sprite:
                    {
                        ...
                        // https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/type!beat/GameplayElements/HitObjectManager_LoadSave.cs#L1502
                        writer.WriteLine(string.Format(
                            CultureInfo.InvariantCulture,
                            @"{0},{1},{2},""{3}"",{4},{5}",
        ...
        private void encodeCommands(TextWriter writer, StoryboardSprite sprite)
        {
            ...
            {
                // https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/type!beat/GameplayElements/HitObjectManager_LoadSave.cs#L1564-L1572
        ...
        private void encodeCommand(TextWriter writer, IStoryboardCommand command, int depth, double relativeToTime = 0)
        {
            ...
            // https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/type!beat/GameplayElements/HitObjectManager_LoadSave.cs#L1546-L1550
            // https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/type!beat/GameplayElements/HitObjectManager_LoadSave.cs#L1690-L1730
            switch (command)
            {
