...
namespace typebeat.Game.Beatmaps
{
    ...
    /// - Create a playable <see cref="Beatmap"/> via <see cref="GetPlayableBeatmap(typebeat.Game.Rulesets.IRulesetInfo,System.Collections.Generic.IReadOnlyList{typebeat.Game.Rulesets.Mods.Mod})"/>.
    /// </summary>
    public interface IWorkingBeatmap
    {
        ...
        /// <see cref="GetPlayableBeatmap(typebeat.Game.Rulesets.IRulesetInfo,System.Collections.Generic.IReadOnlyList{typebeat.Game.Rulesets.Mods.Mod},System.Threading.CancellationToken)"/>
        /// overload instead.
        /// </remarks>
