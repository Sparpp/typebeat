        ...
        where TModel : class, IHasGuidPrimaryKey
    {
        ...
        public Task ImportFromStableAsync(StableStorage stableStorage)
        {
            ...
            if (!storage.ExistsDirectory(ImportFromStablePath))
            {
                ...
                Logger.Log(@$"Folder ""{fullPath}"" not available in the target type!beatstable installation to import {Importer.HumanisedModelName}s.", LoggingTarget.Information, LogLevel.Error);
