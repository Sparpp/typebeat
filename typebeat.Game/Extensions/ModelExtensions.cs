...
namespace typebeat.Game.Extensions
{
    ...
    {
        /// <summary>
        /// Get the relative path in type!beat storage for this file.
        /// </summary>
        ...
        /// <summary>
        /// Check whether this <see cref="IRulesetInfo"/>'s online ID is within the range that defines it as a legacy ruleset (ie. either type!beat, type!beattaiko, type!beatcatch or type!beatmania).
        /// </summary>
        ...
        /// </para>
        /// </remarks>
        /// <seealso href="https://github.com/peppy/osu-stable-reference/blob/67795dba3c308e7d0493b296149dcb073ca47ecb/type!beatcommon/Helpers/GeneralHelper.cs#L41-L46"/>
