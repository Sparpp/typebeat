...
namespace typebeat.Game.Localisation
{
    public static class BeatmapOverlayStrings
    {
        ...
        ///
        /// This includes content that may not be correctly licensed for type!beat usage. Browse at your own risk."
        /// </summary>
...
This includes content that may not be correctly licensed for type!beat usage. Browse at your own risk.");
        ...
        /// <summary>
        /// "Featured Artists are music artists who have collaborated with type!beat to make a selection of their tracks available for use in beatmaps. For some type!beat releases, we showcase only featured artist beatmaps to better support the surrounding ecosystem."
        /// </summary>
        public static LocalisableString FeaturedArtistsTooltip => new TranslatableString(getKey(@"featured_artists_disabled_tooltip"), @"Featured Artists are music artists who have collaborated with type!beat to make a selection of their tracks available for use in beatmaps. For some type!beat releases, we showcase only featured artist beatmaps to better support the surrounding ecosystem.");
