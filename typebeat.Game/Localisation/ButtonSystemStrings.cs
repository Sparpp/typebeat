...
namespace typebeat.Game.Localisation
{
    ...
    {
        private const string prefix = @"typebeat.Game.Resources.Localisation.ButtonSystem";
        ...
        /// <summary>
        /// "While we have released type!beat on mobile platforms to maximise the number of people that can enjoy the game, our focus is still on the PC version.
        ///
