...
namespace typebeat.Game.Localisation
{
    public static class DebugSettingsStrings
    {
        ...
        /// <summary>
        /// "Imports all type!beat files from selected directory"
        /// </summary>
        public static LocalisableString ImportAllFilesFromDirectoryTooltip => new TranslatableString(getKey(@"import_all_files_from_directory_tooltip"), @"Imports all type!beat files from selected directory");
