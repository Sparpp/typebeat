...
namespace typebeat.Game.Localisation
{
    public static class GraphicsSettingsStrings
    {
        ...
        /// <summary>
        /// "Minimise type!beat when switching to another app"
        /// </summary>
        public static LocalisableString MinimiseOnFocusLoss => new TranslatableString(getKey(@"minimise_on_focus_loss"), @"Minimise type!beat when switching to another app");
