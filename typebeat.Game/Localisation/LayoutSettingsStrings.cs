...
namespace typebeat.Game.Localisation
{
    public static class LayoutSettingsStrings
    {
        ...
        /// <summary>
        /// "type!beat is running in exclusive fullscreen, guaranteeing low latency!"
        /// </summary>
        public static LocalisableString OsuIsRunningExclusiveFullscreen => new TranslatableString(getKey(@"osu_is_running_exclusive_fullscreen"), @"type!beat is running in exclusive fullscreen, guaranteeing low latency!");
