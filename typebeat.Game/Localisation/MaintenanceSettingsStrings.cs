...
namespace typebeat.Game.Localisation
{
    public static class MaintenanceSettingsStrings
    {
        ...
        /// <summary>
        /// "The target directory already seems to have an type!beat install. Use that data instead? type!beat will restart."
        /// </summary>
        public static LocalisableString TargetDirectoryAlreadyInstalledOsu => new TranslatableString(getKey(@"target_directory_already_installed_osu"), @"The target directory already seems to have an type!beat install. Use that data instead? type!beat will restart.");
        ...
        /// <summary>
        /// "Please select your type!beatstable install location"
        /// </summary>
        public static LocalisableString StableDirectorySelectHeader => new TranslatableString(getKey(@"stable_directory_select_header"), @"Please select your type!beatstable install location");
