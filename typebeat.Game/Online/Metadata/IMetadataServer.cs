...
namespace typebeat.Game.Online.Metadata
{
    /// <summary>
    /// Metadata server is responsible for keeping the type!beat client up-to-date with various real-time happenings, such as:
    /// <list type="bullet">
