...
namespace typebeat.Game.Online
{
    public abstract class PersistentEndpointClientConnector : IDisposable
    {
        ...
        private async Task handleErrorAndDelay(Exception exception, CancellationToken cancellationToken)
        {
            ...
            // compare: https://github.com/peppy/osu-stable-reference/blob/013c3010a9d495e3471a9c59518de17006f9ad89/type!beat/Online/BanchoClient.cs#L331
            int thisDelay = (int)(retryDelay * RNG.NextDouble(0.75, 1.25));
            // exponential backoff with upper limit
            // compare: https://github.com/peppy/osu-stable-reference/blob/013c3010a9d495e3471a9c59518de17006f9ad89/type!beat/Online/BanchoClient.cs#L539
