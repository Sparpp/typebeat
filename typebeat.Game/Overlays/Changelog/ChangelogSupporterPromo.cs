...
namespace typebeat.Game.Overlays.Changelog
{
    public partial class ChangelogSupporterPromo : CompositeDrawable
    {
        ...
        private void load(OsuColour colour, TextureStore textures, OverlayColourProvider colourProvider)
        {
            ...
            supportLinkText.AddText("Support further development of type!beat and ");
            supportLinkText.AddLink("become an type!beatsupporter", @"https://osu.ppy.sh/home/support", t => t.Font = t.Font.With(weight: FontWeight.Bold));
