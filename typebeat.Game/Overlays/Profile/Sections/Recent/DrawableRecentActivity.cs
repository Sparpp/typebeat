        ...
        private void createMessage()
        {
            switch (activity.Type)
            {
                ...
                case RecentActivityType.UserSupportAgain:
                    addUserLink();
                    addText(" has once again chosen to support type!beat - thanks for your generosity!");
                    break;

                case RecentActivityType.UserSupportFirst:
                    addUserLink();
                    addText(" has become an type!beatsupporter - thanks for your generosity!");
                    break;

                case RecentActivityType.UserSupportGift:
                    addUserLink();
                    addText(" has received the gift of type!beatsupporter!");
                    break;
