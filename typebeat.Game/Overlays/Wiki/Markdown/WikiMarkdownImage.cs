...
using typebeat.Game.Graphics.Containers.Markdown;

namespace typebeat.Game.Overlays.Wiki.Markdown
{
    public partial class WikiMarkdownImage : OsuMarkdownImage
    {
        ...
        protected override ImageContainer CreateImageContainer(string url)
        {
            ...
            // "/wiki/images/*" is route to fetch wiki image from type!beatweb server (see: https://github.com/ppy/osu-web/blob/4205eb66a4da86bdee7835045e4bf28c35456e04/routes/web.php#L289)
