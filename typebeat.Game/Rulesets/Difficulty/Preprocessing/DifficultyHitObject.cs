...
namespace typebeat.Game.Rulesets.Difficulty.Preprocessing
{
    /// <summary>
    ...
    public class DifficultyHitObject
    {
        ...
        private double getRawHitWindow(HitResult hitResult)
        {
            ...
            // This is important for objects such as Slider in type!beat where the object itself has HitWindows set to Empty, but the nested SliderHead has proper hit windows
