...
namespace typebeat.Game.Rulesets.Edit
{
    ...
    public abstract partial class SelectionBlueprint<T> : CompositeDrawable, IStateful<SelectionState>
    {
        ...
        /// <summary>
        /// The <see cref="MenuItem"/>s to be displayed in the context menu for this <see cref="SelectionBlueprint{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// The screen-space main point that causes this <see cref="SelectionBlueprint{T}"/> to be selected via a drag.
        /// </summary>
        ...
        /// <summary>
        /// The screen-space collection of base points on this <see cref="SelectionBlueprint{T}"/> that other objects can be snapped to.
        ...
        /// <summary>
        /// The screen-space quad that outlines this <see cref="SelectionBlueprint{T}"/> for selections.
        /// </summary>
