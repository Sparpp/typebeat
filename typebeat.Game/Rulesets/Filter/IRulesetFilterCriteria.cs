...
namespace typebeat.Game.Rulesets.Filter
{
    /// <summary>
    ...
    public interface IRulesetFilterCriteria
    {
        ...
        /// along with <see cref="FilterQueryParser.TryUpdateCriteriaRange{T}(ref typebeat.Game.Screens.Select.FilterCriteria.OptionalRange{T},typebeat.Game.Screens.Select.Filter.Operator,string,FilterQueryParser.TryParseFunction{T})"/>
