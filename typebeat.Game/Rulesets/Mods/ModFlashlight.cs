...
using typebeat.Game.Graphics.OpenGL.Vertices;
        ...
        where T : HitObject
    {
        ...
        public virtual void ApplyToDrawableRuleset(DrawableRuleset<T> drawableRuleset)
        {
            ...
            drawableRuleset.Overlays.Add(new Container
            {
                ...
                // NegativeInfinity is not used to allow one more thing drawn on top (used in replay analysis overlay in type!beat).
