...
namespace typebeat.Game.Rulesets.Objects.Legacy
{
    public static class LegacyRulesetExtensions
    {
        ...
        /// <summary>
        /// Calculates scale from a CS value, with an optional fudge that was historically applied to the type!beat ruleset.
        /// </summary>
        public static float CalculateScaleFromCircleSize(float circleSize, bool applyFudge = false)
        {
            ...
            //
            //   Builds of type!beat up to 2013-05-04 had the gamefield being rounded down, which caused incorrect radius calculations
