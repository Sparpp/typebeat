...
namespace typebeat.Game.Rulesets.Objects
{
    public static class SliderEventGenerator
    {
        ...
        /// These days, this is implemented in the drawable implementation of Slider in the type!beat ruleset.
        ///
        /// We need to keep the <see cref="SliderEventType.LegacyLastTick"/> *only* for type!beatcatch conversion, which relies on it to generate tiny ticks
        /// correctly.
        /// </summary>
                                                                  ...
                                                                  CancellationToken cancellationToken = default)
        {
            ...
            // Times were simpler. type!beat was but in its infancy and sliders were a new concept.
