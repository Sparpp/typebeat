...
namespace typebeat.Game.Rulesets
{
    public abstract class Ruleset
    {
        ...
        /// </summary>
        public virtual Screens.Edit.EditorScreen? CreateEditorComposeScreen() => null;

        /// <summary>
        /// Whether this ruleset persists beatmaps in a native on-disk text format of its own
        /// rather than the legacy <c>.osu</c> encoder. When true, <see cref="EncodeToNativeFormat"/>
        /// is used to serialise beatmaps for saving and editor undo/redo, and the editor treats
        /// the ruleset as save-capable even though it is not an <see cref="ILegacyRuleset"/>.
        /// </summary>
        public virtual bool CanEncodeToNativeFormat => false;
        ...
        /// <summary>
        /// For a native-format ruleset (<see cref="CanEncodeToNativeFormat"/>), whether two encodings
        /// of a beatmap are equivalent for ONLINE-STATUS purposes: i.e. the edit between them was
        /// cosmetic and a save must NOT demote a ranked map to <c>LocallyModified</c>. Default is exact
        /// text equality; rulesets whose native format carries menu/cosmetic-only fields (type!beat's
        /// intro beatdrop) override this to ignore those fields.
        /// </summary>
