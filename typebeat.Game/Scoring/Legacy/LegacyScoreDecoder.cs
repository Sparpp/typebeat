    ...
    public abstract class LegacyScoreDecoder
    {
        ...
        public Score Parse(Stream stream)
        {
            ...
            using (SerializationReader sr = new SerializationReader(stream))
            {
                ...
                // In the case where the incoming score has either an type!beatstable or old lazer version, we need
...
#pragma warning disable CS0618
            // In type!beat and type!beatmania, some judgements affect combo but aren't stored to scores.
...
#pragma warning restore CS0618
        ...
        private void readLegacyReplay(Replay replay, StreamReader reader)
        {
            ...
            // https://github.com/peppy/osu-stable-reference/blob/e53980dd76857ee899f66ce519ba1597e7874f28/type!beat/GameModes/Play/ReplayWatcher.cs#L62-L67
            ...
            // https://github.com/peppy/osu-stable-reference/blob/e53980dd76857ee899f66ce519ba1597e7874f28/type!beat/GameModes/Play/ReplayWatcher.cs#L69-L71
