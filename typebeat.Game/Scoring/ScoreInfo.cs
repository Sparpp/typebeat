...
namespace typebeat.Game.Scoring
{
    ...
    public class ScoreInfo : RealmObject, IHasGuidPrimaryKey, IHasRealmFiles, ISoftDelete, IEquatable<ScoreInfo>, IScoreInfo
    {
        ...
        /// <summary>
        /// The <see cref="typebeat.Game.Beatmaps.BeatmapInfo.Hash"/> at the point in time when the score was set.
        /// </summary>
        [Indexed]
        ...
        /// This ID is also stored to replays set on type!beatstable.
        /// </remarks>
        [Indexed]
        ...
        /// <summary>
        /// Whether this <see cref="ScoreInfo"/> represents a legacy (type!beatstable) score.
        /// </summary>
