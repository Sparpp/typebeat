...
namespace typebeat.Game.Screens.Menu
{
    public partial class IntroSequence : Container
    {
        ...
        private CircularContainer limeCircle;
        ...
        private void load()
        {
            ...
            Children = new Drawable[]
            {
                ...
                limeCircle = new Circle
                {
                    ...
                    Origin = Anchor.CentreLeft,
                    Position = new Vector2(circle_offset, 0),
                    Colour = Color4Extensions.FromHex(@"c9f24d"), // type!beat: was osu-pink e967a1; now the Caret lime
                },
            };
                    ...
                    using (BeginDelayedSequence(250))
                    {
                        ...
                        using (BeginDelayedSequence(appear_delay))
                        {
                            ...
                            using (BeginDelayedSequence(appear_delay))
                            {
                                ...
                                using (BeginDelayedSequence(appear_delay))
                                {
                                    limeCircle.MoveToX(circle_size / 2, remainingTime(), Easing.InOutQuart);
                                    limeCircle.Delay(rotation_delay).RotateTo(-180, remainingTime() - rotation_delay, Easing.InOutQuart);
                                    limeCircle.ResizeTo(circle_size, remainingTime(), Easing.InOutQuart);
                                }
                            }
                        }
                    }
