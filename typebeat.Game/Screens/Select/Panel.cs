...
namespace typebeat.Game.Screens.Select
{
    public abstract partial class Panel : PoolableDrawable, ICarouselPanel, IHasContextMenu
    {
        ...
        protected override bool OnClick(ClickEvent e)
        {
            ...
            // See https://github.com/ppy/osu/blob/033e13cb3b79e6195ddcd9f659b04095aa52fd2f/typebeat.Game/Graphics/Carousel/Carousel.cs#L1132-L1135.
            if (item != null)
        ...
        public CarouselItem? Item
        {
            ...
            set
            {
                ...
                // See https://github.com/ppy/osu/blob/033e13cb3b79e6195ddcd9f659b04095aa52fd2f/typebeat.Game/Graphics/Carousel/Carousel.cs#L1071
