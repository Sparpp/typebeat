        ...
        private void parseArrayValue(string value, float[] output, bool applyScaleFactor = true)
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                ...
                if (!float.TryParse(values[i], NumberStyles.Float, CultureInfo.InvariantCulture, out float parsedValue))
                    ...
                    // see: https://github.com/ppy/osu/issues/26464, stable code: https://github.com/peppy/osu-stable-reference/blob/3ea48705eb67172c430371dcfc8a16a002ed0d3d/type!beat/Graphics/Skinning/Components/Section.cs#L134-L137
                    parsedValue = 0;
