...
{
    /// <summary>
    /// A skin that looks like type!beatstable as it was around 2008.
    /// </summary>
    /// <remarks>
    /// "Around 2008" was chosen as the cutoff for this skin because that's when the look of core gameplay settled into its final design (until <see cref="DefaultLegacySkin"/>). Skin elements from later versions of type!beat were preferred as long as they only fixed bugs or applied minor tweaks to 2008 elements.
    /// </remarks>
    public class RetroSkin : LegacySkin
    {
        public static SkinInfo CreateInfo() => new SkinInfo
        {
            ...
            Name = "type!beat \"retro\" (2008)",
            Creator = "team type!beat",
            Protected = true,
