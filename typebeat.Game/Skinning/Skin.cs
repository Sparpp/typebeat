...
namespace typebeat.Game.Skinning
{
    public abstract class Skin : IDisposable, ISkin
    {
        ...
        protected Skin(SkinInfo skin, IStorageResourceProvider? resources, IResourceStore<byte[]>? fallbackStore = null, string configurationFilename = @"skin.ini")
        {
            ...
            else
            {
                Configuration = new SkinConfiguration
                {
                    ...
                    // see https://github.com/peppy/osu-stable-reference/blob/1531237b63392e82c003c712faa028406073aa8f/type!beat/Graphics/Skinning/SkinManager.cs#L297-L298
        ...
        private SkinLayoutInfo? parseLayoutInfo(string jsonContent, GlobalSkinnableContainers target)
        {
            ...
            jsonContent = jsonContent.Replace(@"typebeat.Game.Screens.Play.SongProgress", @"typebeat.Game.Screens.Play.HUD.DefaultSongProgress");
            jsonContent = jsonContent.Replace(@"typebeat.Game.Screens.Play.HUD.LegacyComboCounter", @"typebeat.Game.Skinning.LegacyComboCounter");
            jsonContent = jsonContent.Replace(@"typebeat.Game.Skinning.LegacyComboCounter", @"typebeat.Game.Skinning.LegacyDefaultComboCounter");
            jsonContent = jsonContent.Replace(@"typebeat.Game.Screens.Play.HUD.PerformancePointsCounter", @"typebeat.Game.Skinning.Triangles.TrianglesPerformancePointsCounter");
            jsonContent = jsonContent.Replace(@"typebeat.Game.Screens.Play.HUD.UnstableRateCounter", @"typebeat.Game.Skinning.Triangles.TrianglesUnstableRateCounter");
