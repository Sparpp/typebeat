...
using typebeat.Game.Screens.Play.HUD.HitErrorMeters;
using typebeat.Game.Skinning.Triangles;
using osuTK;
...
namespace typebeat.Game.Skinning
{
    public class TrianglesSkin : Skin
    {
        ...
        {
            ID = typebeat.Game.Skinning.SkinInfo.TRIANGLES_SKIN,
            Name = "type!beat \"triangles\" (2017)",
                        ...
                        case GlobalSkinnableContainers.MainHUDComponents:
                            ...
                            })
                            {
                                Children = new Drawable[]
                                {
                                    ...
                                    // type!beat: hit-error meters intentionally omitted from the default HUD.
