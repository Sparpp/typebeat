...
{
    /// <summary>
    /// The goal of this abstract test class is to exercise correct playback of replays sourced from previous type!beat versions.
    ...
    public abstract partial class LegacyReplayPlaybackTestScene : RateAdjustedBeatmapTestScene
    {
        ...
        /// <summary>
        /// This is provided as a convenience for testing behaviour against type!beatstable.
