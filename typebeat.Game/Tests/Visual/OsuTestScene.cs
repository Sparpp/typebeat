...
using typebeat.Game.Tests.Rulesets;
...
namespace typebeat.Game.Tests.Visual
{
    public abstract partial class OsuTestScene : TestScene
    {
        ...
        /// </summary>
        /// <param name="ruleset">The ruleset to create the sample model using. type!beat ruleset will be used if not specified.</param>
